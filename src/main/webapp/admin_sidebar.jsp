...
<aside class="sidebar">
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="${activePage == '' ? 'active' : ''}">
                <a href="${pageContext.request.contextPath}/InventoryServlet">Quản lý kho</a>
            </li>
            <li class="${activePage == '' ? 'active' : ''}">
            ...
            <li class="${activePage == '' ? 'active' : ''}">
                <a href="${pageContext.request.contextPath}/VoucherAdminServlet">Quản lý voucher</a>
            </li>
            <li class="${activePage == '' ? 'active' : ''}">
                <a href="${pageContext.request.contextPath}/admin/customers"> Khách hàng</a>
            </li>
            <li class="${activePage == '' ? 'active' : ''}">
                <a href="${pageContext.request.contextPath}/AdminReviewServlet"> Quản lý đánh giá</a>
            </li>
            <li class="${activePage == '' ? 'active' : ''}">
